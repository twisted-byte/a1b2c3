...
DOWNLOAD_DIR="/userdata/roms/gba"  # Update this to your desired download directory
TEMP_DIR="/tmp/gba_download"  # Temporary directory for downloading and extracting
