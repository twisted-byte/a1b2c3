...
select_letter() {
    # Use the fixed list of available letters to prevent pairing issues
    dialog --title "Select a Letter" --menu "Choose a letter" 15 50 8 \
...
# Pre-generate the letter list to ensure consistency across iterations
